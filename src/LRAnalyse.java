...
public class LRAnalyse {
    ...
    public static void main(String[] args) {
        ...
        LRAnalyse lrAnalyse = new LRAnalyse(grammar1);
        lrAnalyse.start(lexer, generateLRMachine.getAction(), generateLRMachine.getGoTo());
    }

    public Node start(Lexer lexer, Map<Integer, Map<String, TableElementType>> action, Map<Integer, Map<String, Integer>> goTo) {
